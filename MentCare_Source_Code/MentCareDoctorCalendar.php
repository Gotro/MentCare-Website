...
class MentCareDoctorCalendar {
	...
	/*
	$doctorID is the actual doctorID different then userID
	*/
	public function __construct($aServer, $aUser, $aPassword, $aDatabase, $doctorID) {
	    $server = $aServer;
		$user = $aUser;
		$password = $aPassword;
		$database = $aDatabase;
	...
	on patient.userID = users.userID where date = '".$curDate."' && appointments.doctorID = ".$this->userID;
